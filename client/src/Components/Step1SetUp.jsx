...
const handleUploadResume = async () => {
  ...
  return (
    ...
    bg-linear-to-br from-gray-100 to-gray-200 px-4'>
      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2
      overflow-hidden'>
...
{/* LEFT SIDE =============================================================== */}
        ...
        className='relative bg-linear-to-br from-green-50 to-green-100 p-12
        flex flex-col justify-center'>
          ...
          <div className='space-y-5'>
          {
            [
              ...
              key={index} className='flex items-center space-x-4 bg-white
...
{/* RIGHT SIDE=============================================================== */}
        ...
        >
          ...
          className='w-full pl-12 pr-4 py-3 border border-gay-200 rounded-xl focus:ring-2
          ...
          {!analysisDone && (
            ...
            hover:border-green-500 hover:bg-green-50 transition'>
             ...
             {resumeFile && (
              ...
              transition'
              >{analyzing ? "Analyzing...":"Analyze Resume"}</motion.button>
             )} 
            </motion.div>
          )}
